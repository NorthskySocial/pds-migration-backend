...
impl AppConfig {
    pub fn from_env() -> Self {
        ...
        let upload_max_retries = env::var("UPLOAD_MAX_RETRIES").unwrap_or("3".to_string());
        ...
        Self {
            server: ServerConfig {
                ...
                upload_max_retries: upload_max_retries.parse().unwrap(),
    ...
    fn from_env_uses_defaults_when_unset() {
        with_env_guard(
            ...
            || {
                ...
                assert_eq!(cfg.server.upload_max_retries, 3);
    ...
    fn from_env_reads_overrides() {
        with_env_guard(
            ...
            || {
                ...
                assert_eq!(cfg.server.upload_max_retries, 7);

...
use pdsmigration_common::{RequestTokenRequest, REDACTED};
...
impl fmt::Debug for RequestTokenApiRequest {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("RequestTokenApiRequest")
...
mod tests {
    ...
    #[test]
    fn request_token_api_request_redacts_token() {
        let req = RequestTokenApiRequest {
